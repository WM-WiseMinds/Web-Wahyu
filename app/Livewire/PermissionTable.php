...
final class PermissionTable extends PowerGridComponent
{
    ...
    public function actions(Permission $row): array
    {
        ...
        // Jika user memiliki permission 'update' maka tombol edit akan ditampilkan
        ...
        // Jika user memiliki permission 'delete' maka tombol delete akan ditampilkan
    ...
    public function exportPdf()
    {
        ...
        return response()->download($path . '/permissions.pdf');
    }
