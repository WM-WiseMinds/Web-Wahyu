        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border px-4 py-2">
                    <img src="{{ asset('storage/foto-pemeliharaan/' . $row->bukti_pembayaran) }}"
                        alt="{{ $row->nama }}" class="w-32 h-32 mb-5">
                    <x-button>
                        <a href="{{ asset('storage/foto-pemeliharaan/' . $row->bukti_pembayaran) }}" download>
                            Download
                        </a>
                    </x-button>
                </td>
