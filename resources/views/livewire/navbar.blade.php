<div class="navbar bg-gradient-to-t from-orange-700 to-orange-600">
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="0"
                ...
                <li><a href="{{ url('/mobils') }}">Mobil</a></li>
            </ul>
        </div>
        <a class="btn btn-ghost text-xl text-white">PT Karya Marga Jaya</a>
    </div>
    ...
    <div class="navbar-end">
        @if (Route::has('login'))
            @auth
                <a href="{{ route('keranjang') }}" class="mx-3"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24" fill="#FFFF" class="w-6 h-6">
                        <path
